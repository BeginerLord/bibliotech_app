...
type AuthorTablePaginationProps = {
  page: number
  onPrevPage: () => void
  onNextPage: () => void
...
export default function AuthorTablePagination({
  page,
  onPrevPage,
  onNextPage,
  filteredCount,
